...
mod m20230517_155027_create_comic_genres_table;
mod m20230517_160145_create_comics_genres_mapping_table;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20230517_155027_create_comic_genres_table::Migration),
            Box::new(m20230517_160145_create_comics_genres_mapping_table::Migration),
        ]
    }
}
